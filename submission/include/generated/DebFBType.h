...
struct PolyUnit FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  int32_t ntt_info() const {
    return GetField<int32_t>(VT_NTT_INFO, 0);
  }
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<int32_t>(verifier, VT_NTT_INFO, 4) &&
...
struct PolyUnitBuilder {
  ...
  void add_ntt_info(int32_t ntt_info) {
    fbb_.AddElement<int32_t>(PolyUnit::VT_NTT_INFO, ntt_info, 0);
  }
...
inline ::flatbuffers::Offset<PolyUnit> CreatePolyUnit(
  ...
  builder_.add_ntt_info(ntt_info);
